...
abs_builddir = /home/jbs/Repos/gdmap-0.8.1
abs_srcdir = /home/jbs/Repos/gdmap-0.8.1
...
top_srcdir = .
SUBDIRS = src po data
EXTRA_DIST = autogen.sh ChangeLog intltool-extract.in intltool-merge.in intltool-update.in
all: config.h
